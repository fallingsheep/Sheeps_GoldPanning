...
RegisterNetEvent('Sheeps_goldpanning:StartPaning')
AddEventHandler('Sheeps_goldpanning:StartPaning', function()
            if not Panning then 
                Panning = true
                ...
                if foundwater == false then
                    TriggerEvent("vorp:NotifyTop", Config.gold_no_collect, 10000)
                end
            end           
end)
